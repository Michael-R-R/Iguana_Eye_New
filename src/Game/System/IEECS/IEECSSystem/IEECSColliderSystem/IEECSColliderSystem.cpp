...
QDataStream& IEECSColliderSystem::serialize(QDataStream& out, const IESerializable& obj) const
{
...
QDataStream& IEECSColliderSystem::deserialize(QDataStream& in, IESerializable& obj)
{
