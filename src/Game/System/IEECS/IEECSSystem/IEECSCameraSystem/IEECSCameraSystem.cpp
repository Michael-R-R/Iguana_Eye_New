...
QDataStream& IEECSCameraSystem::serialize(QDataStream& out, const IESerializable& obj) const
{
...
QDataStream& IEECSCameraSystem::deserialize(QDataStream& in, IESerializable& obj)
{
