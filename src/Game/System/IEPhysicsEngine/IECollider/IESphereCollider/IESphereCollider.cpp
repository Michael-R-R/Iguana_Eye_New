...
QDataStream& IESphereCollider::serialize(QDataStream& out, const IESerializable& obj) const
{
...
QDataStream& IESphereCollider::deserialize(QDataStream& in, IESerializable& obj)
{
