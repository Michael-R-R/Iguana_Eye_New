...
QDataStream& IEBaseRigidbody::serialize(QDataStream& out, const IESerializable& obj) const
{
...
QDataStream& IEBaseRigidbody::deserialize(QDataStream& in, IESerializable& obj)
{
