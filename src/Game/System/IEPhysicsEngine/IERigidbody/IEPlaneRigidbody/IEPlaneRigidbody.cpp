...
QDataStream& IEPlaneRigidbody::serialize(QDataStream& out, const IESerializable& obj) const
{
...
QDataStream& IEPlaneRigidbody::deserialize(QDataStream& in, IESerializable& obj)
{
