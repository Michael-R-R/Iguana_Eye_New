...
QDataStream& IECapsuleRigidbody::serialize(QDataStream& out, const IESerializable& obj) const
{
...
QDataStream& IECapsuleRigidbody::deserialize(QDataStream& in, IESerializable& obj)
{
