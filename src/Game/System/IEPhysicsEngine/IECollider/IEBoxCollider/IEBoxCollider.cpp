...
QDataStream& IEBoxCollider::serialize(QDataStream& out, const IESerializable& obj) const
{
...
QDataStream& IEBoxCollider::deserialize(QDataStream& in, IESerializable& obj)
{
