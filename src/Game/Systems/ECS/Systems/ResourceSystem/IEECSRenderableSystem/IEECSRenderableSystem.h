...
class IEECSRenderableSystem : public IEECSResourceSystem
{
    ...
    QMap<uint64_t, QMap<IEEntity, int>> shownEntityMap;
    QMap<uint64_t, QVector<IEEntity>> shownEntityList;

    QMap<uint64_t, QMap<IEEntity, int>> hiddenEntityMap;
    QMap<uint64_t, QVector<IEEntity>> hiddenEntityList;
