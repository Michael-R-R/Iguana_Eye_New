...
IEECSHierarchySystem::IEECSHierarchySystem(QObject* parent) :
    IEECSSystem(typeid(IEECSHierarchySystem).hash_code(), parent),
    data()
{
...
QDataStream& IEECSHierarchySystem::serialize(QDataStream& out, const IESerializable& obj) const
{
...
QDataStream& IEECSHierarchySystem::deserialize(QDataStream& in, IESerializable& obj)
{
