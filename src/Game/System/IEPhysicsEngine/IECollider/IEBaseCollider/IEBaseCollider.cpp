...
QDataStream& IEBaseCollider::serialize(QDataStream& out, const IESerializable& obj) const
{
...
QDataStream& IEBaseCollider::deserialize(QDataStream& in, IESerializable& obj)
{
