...
QDataStream& IEECSMeshSystem::serialize(QDataStream& out, const IESerializable& obj) const
{
    return IEECSResourceSystem::serialize(out, obj);
}

QDataStream& IEECSMeshSystem::deserialize(QDataStream& in, IESerializable& obj)
{
