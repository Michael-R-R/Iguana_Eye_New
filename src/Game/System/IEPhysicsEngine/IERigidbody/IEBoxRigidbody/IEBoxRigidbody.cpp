...
QDataStream& IEBoxRigidbody::serialize(QDataStream& out, const IESerializable& obj) const
{
...
QDataStream& IEBoxRigidbody::deserialize(QDataStream& in, IESerializable& obj)
{
